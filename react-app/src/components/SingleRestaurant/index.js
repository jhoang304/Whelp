                        ...
                        <div className="bottom-right-section">
                            <div className="side-bar">
                                ...
                                <div className="website-line">
                                    <a className="bottom-border website-link" href={singleRestaurant.website.startsWith("http") ? singleRestaurant.website : `http://${singleRestaurant.website}`}>
