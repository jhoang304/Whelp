...
from .postcode import POSTCODE_MAX, POSTCODE_MESSAGE, POSTCODE_MIN, POSTCODE_REGEX
...
class RestaurantForm(FlaskForm):
    ...
    zipcode = StringField("zipcode",validators=[DataRequired(), Length(min=POSTCODE_MIN, max=POSTCODE_MAX), Regexp(POSTCODE_REGEX, message=POSTCODE_MESSAGE)])
