...
from .postcode import (
    coerce_to_text, POSTCODE_MAX, POSTCODE_MESSAGE, POSTCODE_MIN, POSTCODE_REGEX,
)
...
class RestaurantForm(FlaskForm):
    ...
    zipcode = StringField("zipcode",filters=[coerce_to_text],validators=[DataRequired(), Length(min=POSTCODE_MIN, max=POSTCODE_MAX), Regexp(POSTCODE_REGEX, message=POSTCODE_MESSAGE)])
